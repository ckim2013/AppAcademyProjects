...
def craiglockhart_to_sighthill
  ...
  FROM
    stops AS start_stop
  JOIN
    routes AS start_route ON start_route.stop_id = start_stop.id -- We only have partial table that goes to Craiglockhart
  JOIN
    routes AS s_to_t_route ON s_to_t_route.company = start_route.company AND s_to_t_route.num = start_route.num
  JOIN
    stops AS t_stops ON t_stops.id = s_to_t_route.stop_id
  WHERE
    start_stop = 'Craiglockhart'
  SQL
end
